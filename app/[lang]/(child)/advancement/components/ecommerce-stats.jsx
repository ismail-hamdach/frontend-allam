  ...
  const data = [
    {
      ...
      description: "Words fully learned"
    },
    {
      text: "Hear my words",
      total: "0",
    ...
    },
    {
      ...
      description: "New conversations completed"
    },
      ...
      {data.map((item, index) => (
        ...
        >
          ...
          <div className="flex items-center gap-1">
            <span className="text-lg font-semibold text-default-900  dark:text-primary-foreground">{item.total + " " + item.description}</span>
          </div>
        </div>
      ))}
    </>
